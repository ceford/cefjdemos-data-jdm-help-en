<!-- Filename: Help4.x:Menus_Menu_Item_Weblink_Categories / Display title: Menu Item: List All Web Link Categories -->
...
alt="Menu Item List All Web Link Categories screen" />
...
alt="Menu Item List All Web Link Categories categories tab" />
...
alt="Menu Item List All Web Link Categories category tab" />
...
alt="Menu Item List All Web Link Categories list layout tab" />
