<!-- Filename: Help4.x:Admin_Modules:_User_Menu / Display title: Modules: User Menu -->
...
alt="modules user menu module tab" />
...
alt="modules user menu advanced tab" />
...
alt="modules user menu permissions tab" />
