<!-- Filename: Help4.x:Admin_Modules:_Frontend_Link / Display title: Modules: Frontend Link -->
...
alt="modules frontend link module tab" />
...
alt="modules frontend link advanced tab" />
...
alt="modules frontend link permissions tab" />
