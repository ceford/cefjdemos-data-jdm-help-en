<!-- Filename: Help4.x:Admin_Modules:_Feed_Display / Display title: Modules: Feed Display -->
...
alt="modules feed display module tab" />
...
alt="modules feed display advanced tab" />
...
alt="modules feed display permissions tab" />
...
alt="modules feed display administrator view" />
