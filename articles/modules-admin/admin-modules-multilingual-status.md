<!-- Filename: Help4.x:Admin_Modules:_Multilingual_Status / Display title: Modules: Multilingual Status -->
...
alt="modules multilingual status module tab" />
...
alt="modules multilingual status advanced tab" />
...
alt="modules multilingual status permissions tab" />
...
alt="modules multilingual status example report" />
