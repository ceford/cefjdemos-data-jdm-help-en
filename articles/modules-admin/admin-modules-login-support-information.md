<!-- Filename: Help4.x:Admin_Modules:_Login_Support_Information / Display title: Modules: Login Support Information -->
...
alt="modules login support information module tab" />
...
- **Show Title.** (Show/Hide) Choose whether to show or hide the modules
  ...
  above.
- **Position.** Choose the *module position* you wish this module to be
  displayed in. A custom module position can be entered for use with the
  load position plugin or the position button can be pressed to select a
  module position from the template.
...
alt="modules login support information advanced tab" />
...
alt="modules login support information permissions tab" />
