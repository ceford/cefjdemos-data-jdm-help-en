<!-- Filename: Help4.x:Admin_Modules:_Login_Form / Display title: Modules: Login Form -->
...
alt="modules login form module tab" />
...
- **Position.** Choose the module position
  you wish this module to be displayed in. A custom module position can be
  entered for use with the load position plugin or the position button can be
  pressed to select a module position from the template.
...
alt="modules login form advanced tab" />
...
alt="modules login form permissions tab" />
